    ...
    if (/**/ process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
        ...
        window.addEventListener('load', () => {
            ...
            window.addEventListener('online', () => {
                if (!isAppOnline) {
                    console.log("The app is running online.");
                    config.toast.info('La connexion internet est de retour !', config.toastOptions);
                    isAppOnline = true;
                }
            });

            window.addEventListener('offline', () => {
                console.log("The app is running offline.");
                config.toast.warn('La connexion internet a été perdue...', config.toastOptions);
                isAppOnline = false;
            });
...
function checkValidServiceWorker(swUrl, config) {
    ...
    console.log("Checking if the service worker can be found: " + swUrl);
    fetch(swUrl, {
